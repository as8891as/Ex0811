...
public class MainActivity extends AppCompatActivity {
    ...
    public void addition(View view) {
        if (!eT_numbersDisplay.getText().toString().isEmpty() && !eT_numbersDisplay.getText().toString().equals(".") && !eT_numbersDisplay.getText().toString().equals("-") && eT_numbersDisplay.getText().toString().matches("[^aiInNfty]*") && (eT_numbersDisplay.getText().toString().indexOf('E') == -1 || (eT_numbersDisplay.getText().toString().indexOf('E') > 0 && eT_numbersDisplay.getText().toString().indexOf('E') < eT_numbersDisplay.getText().toString().length() - 1 && eT_numbersDisplay.getText().toString().charAt(eT_numbersDisplay.getText().toString().indexOf('E') - 1) != '-' && eT_numbersDisplay.getText().toString().charAt(eT_numbersDisplay.getText().toString().indexOf('E') - 1) != '.' && (Character.isDigit(eT_numbersDisplay.getText().toString().charAt(eT_numbersDisplay.getText().toString().indexOf('E') + 1)) || (eT_numbersDisplay.getText().toString().charAt(eT_numbersDisplay.getText().toString().indexOf('E') + 1) == '-' && eT_numbersDisplay.getText().toString().length() > eT_numbersDisplay.getText().toString().indexOf('E') + 2 && Character.isDigit(eT_numbersDisplay.getText().toString().charAt(eT_numbersDisplay.getText().toString().indexOf('E') + 2))))))) {
            resultGiven = false;
